...
function Overview({ onStart, onPlan }) { return <div className="content fade-in">
  <section className="hero"><div><div className="eyebrow"><span className="pulse"></span>训练进度 · 第 3 轮</div><h2>把每一次回答，<br /><em>变成下一次进步的证据。</em></h2><p>不只告诉你得了多少分。定位回答中缺失的能力证据，给出下一步应该练什么。</p><div className="hero-actions"><button className="primary" onClick={onStart}>继续模拟面试 <span>→</span></button><button className="secondary" onClick={onPlan}>查看训练计划</button></div></div><div className="hero-orbit"><div className="orbit orbit-1"></div><div className="orbit orbit-2"></div><div className="orbit-core"><b>—</b><span>当前匹配度</span></div><div className="orbit-node node-a">回答<br /><strong>12</strong></div><div className="orbit-node node-b">证据<br /><strong>28</strong></div><div className="orbit-node node-c">缺口<br /><strong>04</strong></div></div></section>
